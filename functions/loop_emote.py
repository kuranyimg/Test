...
(['Emote Outfit2', 'emote outfit2', '31'], 'emote-outfit2', 11.94),
(['Emote Pose12', 'emote pose12', '32'], 'emote-pose12', 5.81),
(['Emote Fading', 'emote fading', '33'], 'emote-fading', 14.05),
(['Emote Pose13', 'emote pose13', '34'], 'emote-pose13', 6.39),
(['Profile Breakscreen', 'profile breakscreen', '35'], 'profile-breakscreen', 10.70),
(['Emote Surf', 'emote surf', '36'], 'emote-surf', 19.01),
(['Emote Cartwheel', 'emote cartwheel', '37'], 'emote-cartwheel', 7.94),
(['Emote Kissing Passionate', 'emote kissing passionate', '38'], 'emote-kissing-passionate', 10.47),
(['Dance Tiktok1', 'dance tiktok1', '39'], 'dance-tiktok1', 12.42),
(['Run Vertical', 'run vertical', '40'], 'run-vertical', 3.86),
(['Emote Flirt', 'emote flirt', '41'], 'emote-flirt', 7.95),
(['Emote Receive Disappointed', 'emote receive disappointed', '42'], 'emote-receive-disappointed', 7.14),
(['Emote Gooey', 'emote gooey', '43'], 'emote-gooey', 5.82),
(['Emote Oops', 'emote oops', '44'], 'emote-oops', 8.02),
(['Walk Vertical', 'walk vertical', '45'], 'walk-vertical', 4.18),
(['Thief', 'emote thief', '46'], 'emote-thief', 6.89),
(['Sheephop', 'emote sheephop', '47'], 'emote-sheephop', 3.78),
(['Runhop', 'emote runhop', '48'], 'emote-runhop', 8.72),
([' Tiktok15', 'dance tiktok15', '49'], 'dance-tiktok15', 16.11),
(['Receive Happy', 'emote receive happy', '50'], 'emote-receive-happy', 5.94),
(['Tiktok6', 'dance tiktok6', '51'], 'dance-tiktok6', 11.99),
(['Confused2', 'emote confused2', '52'], 'emote-confused2', 10.06),
(['Muscle Pose', 'muscle pose', '53'], 'emote-pose4', 6.08),
(['Dinner', 'emote dinner', '54'], 'emote-dinner', 14.25),
(['Wavey', 'emote wavey', '55'], 'emote-wavey', 12.60),
(['Pose2', 'emote pose2', '56'], 'emote-pose2', 7.20),
(['DShuffle', 'dance shuffle', '57'], 'dance-shuffle', 9.05),
([' Twitched', 'emote twitched', '58'], 'emote-twitched', 9.61),
([' Juggling', 'emote juggling', '59'], 'emote-juggling', 5.83),
(['Idle Dance Tiktok6', 'idle dance tiktok6', '60'], 'idle-dance-tiktok6', 9.73),
(['Emote Opera', 'emote opera', '61'], 'emote-opera', 5.76),
...
(['Idle Cold', 'idle cold', '68'], 'idle-cold', 17.71),
(['Emote Pose11', 'emote pose11', '69'], 'emote-pose11', 5.11),
(['Handwalk', ' handwalk', '70'], 'emote-handwalk', 7.77),
([' Dramatic', ' dramatic', '71'], 'emote-dramatic', 9.10),
(['Outfit', 'emote outfit', '72'], 'emote-outfit', 13.20),
(['Idle Phone', 'idle phone', '73'], 'idle-phone', 31.36),
(['Sit Chair', 'sit chair', '74'], 'sit-chair', 3.30),
(['Idle Space', 'idle space', '75'], 'idle-space', 37.78),
...
(['Blowing Kisses', 'blowing kisses', '87'], 'emote-blowkisses', 5.98),
(['Fairy Twirl', 'fairy twirl', '88'], 'emote-looping', 9.89),
(['Fairy Float', 'fairy float', '89'], 'idle-floating', 27.60),
(['Karma Dance', 'karma dance', '90'], 'dance-wild', 16.25),
(['Moonlit Howl', 'moonlit howl', '91'], 'emote-howl', 8.10),
(['Nocturnal Howl', 'nocturnal howl', '92'], 'idle-howl', 48.62),
(['Trampoline', 'trampoline', '93'], 'emote-trampoline', 6.11),
(['Launch', 'launch', '94'], 'emote-launch', 10.88),
(['Cute Salute', 'cute salute', '95'], 'emote-cutesalute', 3.79),
(['At Attention', 'at attention', '96'], 'emote-salute', 4.79),
(['Wop Dance', 'wop dance', '97'], 'dance-tiktok11', 11.37),
(['Push It', 'push it', '98'], 'dance-employee', 8.55),
(['This Is For You!', 'this is for you', '99'], 'emote-gift', 6.09),
(['Sweet Little Moves', 'sweet little moves', '100'], 'dance-touch', 13.15),
(['Repose', 'repose', '101'], 'sit-relaxed', 31.21),
(['Sleigh Ride', 'sleigh ride', '102'], 'emote-sleigh', 12.51),
(['Gimme Attention!', 'gimme attention', '103'], 'emote-attention', 5.65),
(['Jingle Hop', 'jingle hop', '104'], 'dance-jinglebell', 12.09),
(['Timejump', 'timejump', '105'], 'emote-timejump', 5.51),
(['Gotta Go!', 'gotta go', '106'], 'idle-toilet', 33.48),
(['Bit Nervous', 'bit nervous', '107'], 'idle-nervous', 22.81),
(['Scritchy', 'scritchy', '108'], 'idle-wild', 27.35),
(['Ice Skating', 'ice skating', '109'], 'emote-iceskating', 8.41),
(['Laid Back', 'laid back', '110'], 'sit-open', 27.28),
(['Party Time!', 'party time', '111'], 'emote-celebrate', 4.35),
(['Shrink', 'shrink', '112'], 'emote-shrink', 9.99),
(['Arabesque', 'arabesque', '113'], 'emote-pose10', 5.00),
(['Bashful Blush', 'bashful blush', '114'], 'emote-shy2', 6
(['Possessed Puppet', 'possessed puppet', '115'], 'emote-puppet', 17.89),
(['Revelations', 'revelations', '116'], 'emote-headblowup', 13.66),
(['Watch Your Back', 'watch your back', '117'], 'emote-creepycute', 9.01),
(['Creepy Puppet', 'creepy puppet', '118'], 'dance-creepypuppet', 7.79),
(['Saunter Sway', 'saunter sway', '119'], 'dance-anime', 9.60),
(['Groovy Penguin', 'groovy penguin', '120'], 'dance-pinguin', 12.81),
(['Air Guitar', 'air guitar', '121'], 'idle-guitar', 14.15),
(['Ready To Rumble', 'ready to rumble', '122'], 'emote-boxer', 6.75),
(['Celebration Step', 'celebration step', '123'], 'emote-celebrationstep', 5.18),
(['Big Surprise', 'big surprise', '124'], 'emote-pose6', 6.46),
(['Ditzy Pose', 'ditzy pose', '125'], 'emote-pose9', 6.00),
(['Stargazing', 'stargazing', '126'], 'emote-stargazer', 7.93),
(['Dance Wrong', 'dance wrong', '127'], 'dance-wrong', 13.60),
(['UWU Mood', 'uwu mood', '128'], 'idle-uwu', 25.50),
(['Emote Fashionista', 'emote fashionista', '129'], 'emote-fashionista', 6.33),
(['Dance Icecream', 'dance icecream', '130'], 'dance-icecream', 16.58),
(['Emote Gravity', 'emote gravity', '131'], 'emote-gravity', 9.02),
(['Emote Punkguitar', 'emote punkguitar', '132'], 'emote-punkguitar', 10.59),
(['Say So Dance', 'say so dance', '133'], 'idle-dance-tiktok4', 16.55),
(['I'm A Cutie!', ' cutie', '134'], 'emote-cutey', 4.07),
(['Fashion Pose', 'fashion pose', '135'], 'emote-pose5', 5.49),
(['I Challenge You!', 'i challenge you', '136'], 'emote-pose3', 5.57),
(['Flirty Wink', 'flirty wink', '137'], 'emote-pose1', 4.71),
(['A Casual Dance', 'a casual dance', '138'], 'idle-dance-casual', 9.57),
(['Cheerful', 'cheerful', '139'], 'emote-pose8', 5.62),
(['Embracing Model', 'embracing model', '140'], 'emote-pose7', 5.28),
 (['Fighter', 'fighter', '141'], 'idle-fighter', 18.64),
(['Shuffle Dance', 'shuffle dance', '142'], 'dance-tiktok10', 9.41),
(['Renegade', 'renegade', '143'], 'idle-dance-tiktok7', 14.05),
(['Grave Dance', 'grave dance', '144'], 'dance-weird', 22.87),
(['Viral Groove', 'viral groove', '145'], 'dance-tiktok9', 13.04),
(['Emote Cute', 'emote cute', '146'], 'emote-cute', 7.20),
(['Lambi\'s Pose', 'lambi\'s pose', '147'], 'emote-superpose', 5.43),
(['Froggie Hop', 'froggie hop', '148'], 'emote-frog', 16.14),
(['Sing Along', 'sing along', '149'], 'idle_singing', 11.31),
(['Energy Ball', 'energy ball', '150'], 'emote-energyball', 8.28),
(['Maniac', 'maniac', '151'], 'emote-maniac', 5.94),
(['Sword Fight', 'sword fight', '152'], 'emote-swordfight', 7.71),
(['Teleport', 'teleport', '153'], 'emote-teleporting', 12.89),
(['Floating', 'floating', '154'], 'emote-float', 9.26),
(['Telekinesis', 'telekinesis', '155'], 'emote-telekinesis', 11.01),
(['Slap', 'slap', '156'], 'emote-slap', 4.06),
(['Pissed Off', 'pissed off', '157'], 'emote-frustrated', 6.41),
(['Embarrassed', 'embarrassed', '158'], 'emote-embarrassed', 9.09),
(['Enthused', 'enthused', '159'], 'idle-enthusiastic', 17.53),
(['Confusion', 'confusion', '160'], 'emote-confused', 9.58),
(['Shopping', ' go shopping', '161'], 'dance-shoppingcart', 5.56),
(['ROFL!', 'rofl', '162'], 'emote-rofl', 7.65),
(['Roll', 'roll', '163'], 'emote-roll', 4.31),
(['Super Run', 'super run', '164'], 'emote-superrun', 7.16),
(['Super Punch', 'super punch', '165'], 'emote-superpunch', 5.75),
(['Super Kick', 'super kick', '166'], 'emote-kicking', 6.21),
(['Falling Apart', 'falling apart', '167'], 'emote-apart', 5.98),
(['Partner Hug', 'partner hug', '168'], 'emote-hug', 4.53),
(['Secret Handshake', 'secret handshake', '169'], 'emote-secrethandshake', 6.28),
(['Peekaboo!', 'peekaboo', '170'], 'emote-peekaboo', 4.52),
(['Monster Fail', 'monster fail', '171'], 'emote-monster_fail', 5.42),
(['Zombie Dance', 'zombie dance', '172'], 'dance-zombie', 13.83),
(['Rope Pull', 'rope pull', '173'], 'emote-ropepull', 10.69),
(['Proposing', 'proposing', '174'], 'emote-proposing', 5.91),
(['Sumo Fight', 'sumo fight', '175'], 'emote-sumo', 11.64),
(['Charging', 'charging', '176'], 'emote-charging', 9.53),
(['Ninja Run', 'ninja run', '177'], 'emote-ninjarun', 6.50),
(['Elbow Bump', 'elbow bump', '178'], 'emote-elbowbump', 6.44),
(['Irritated', 'irritated', '179'], 'idle-angry', 26.07),
(['Home Run!', 'home run', '180'], 'emote-baseball', 8.47),
 (['Revival', 'revival', '201'], 'emote-death', 8.00),
(['Penny\'s Dance', 'penny\'s dance', '202'], 'dance-pennywise', 4.16),
(['Sleepy', 'sleepy', '203'], 'idle-sleep', 3.35),
(['Attentive', 'attentive', '204'], 'idle_layingdown', 26.11),
(['Theatrical', 'theatrical', '205'], 'emote-theatrical', 11.00),
(['Faint', 'faint', '206'], 'emote-fainting', 18.55),
(['Relaxed', 'relaxed', '207'], 'idle_layingdown2', 22.59),
(['I Believe I Can Fly', 'i believe i can fly', '208'], 'emote-wings', 14.21),
(['Amused', 'amused', '209'], 'emote-laughing2', 6.60),
(['Floss', 'floss', '210'], 'dance-floss', 23.13),
(['Don\'t Start Now', 'don\'t start now', '211'], 'dance-tiktok2', 11.37),
(['Model', 'model', '212'], 'emote-model', 7.43),
...
(['Zombie', 'zombie', '216'], 'idle_zombie', 31.39),
(['Cold', 'cold', '217'], 'emote-cold', 5.17),
(['Bunny Hop', 'bunny hop', '218'], 'emote-bunnyhop', 13.63),
(['Disco', 'disco', '219'], 'emote-disco', 6.14),
(['Wiggle Dance', 'wiggle dance', '220'], 'dance-sexy', 13.70),
(['Heart Hands', 'heart hands', '221'], 'emote-heartfingers', 5.18),
(['Savage Dance', 'savage dance', '222'], 'dance-tiktok8', 13.10),
(['Ghost Float', 'ghost float', '223'], 'emote-ghost-idle', 20.43),
(['Sneeze', 'sneeze', '224'], 'emoji-sneeze', 4.33),
(['Pray', 'pray', '225'], 'emoji-pray', 6.00),
(['Handstand', 'handstand', '226'], 'emote-handstand', 5.89),
...
(['Partner Heart Arms', 'partner heart arms', '230'], 'emote-heartshape', 7.60),
