...
emote_list: list[tuple[list[str], str, float]] = [
    ...
    (['106', 'layingdown', 'rest'], 'idle_layingdown', 25),
    ...
    (['relaxing'], 'idle-floorsleeping2', 15.25),
    (['coz'], 'idle-floorsleeping', 10.00),
    ...
    (['ghost float'], 'emote-ghost-idle', 16.57),
