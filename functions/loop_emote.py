...
emote_list: list[tuple[list[str], str, float]] = [
    ...
    (['3', 'relaxed', 'Relaxed'], 'idle_layingdown2', 21.55),
    (['4', 'attentive', 'Attentive'], 'idle_layingdown', 24.59),
    ...
    (['18', 'relaxing', 'Relaxing'], 'idle-floorsleeping2', 17.25),
    (['19', 'nap', 'Nap', 'cozynap', 'Cozy Nap'], 'idle-floorsleeping', 13.94),
    ...
    (['75', 'ghost float', 'Ghost float', 'ghost', 'Ghost'], 'emote-ghost-idle', 19.57),
    ...
    (["124", "savage dance", "Savage Dance"], "dance-tiktok8", 10.94),
    (["125", "don't start now", "Don't Start Now"], "dance-tiktok2", 10.39),
    ...
    (["203", "relaxed", "Relaxed"], "sit-relaxed", 29.889858),
    (["204", "laid back", "Laid Back"], "sit-open", 26.025963),
